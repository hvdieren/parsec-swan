...
void sub_Deduplicate_df(obj::inoutdep<chunk_t *>chunk, obj::inoutdep /*cinoutdep*/ <hashtable*>) {
...
void SwanIntegratedPipeline(struct thread_args * args) {
  ...
  obj::object_t<hashtable *> cache_obj; // TODO: unversioned
  cache_obj = cache;
  ...
  while (1) {
	...
	{
	obj::object_t<std::list<chunk_t *>> l;
	spawn(sub_FragmentRefine_df, (obj::inoutdep /*cinoutdep*/ <hashtable*>)cache_obj, (obj::inoutdep<int>)fd_out, (obj::indep<chunk_t*>)chunk_obj, (obj::outdep<std::list<chunk_t*>>)l );
	ssync();
	std::list<chunk_t *> ll = l;
	for( auto I=ll.begin(), E=ll.end(); I != E; ++I ) {
	    call(set_chunk_obj, (obj::outdep<chunk_t*>)chunk_obj, *I);
